...
class AccountsCoordinator: Coordinator {
    ...
    func showInfoSheet(for account: Wallet, sender: UIView) {
        ...
        let copyAction = UIAlertAction(
            title: NSLocalizedString("Copy TrustCore.Address", value: "Copy TrustCore.Address", comment: ""),
            style: .default
        ) { _ in
            UIPasteboard.general.string = account.address.data.addressString
        }
    ...
    func exportPrivateKey(for account: TrustKeystore.Account) {
