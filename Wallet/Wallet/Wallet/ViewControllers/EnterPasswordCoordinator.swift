...
class EnterPasswordCoordinator: Coordinator {
    ...
    private let account: TrustKeystore.Account
...
extension EnterPasswordCoordinator: EnterPasswordViewControllerDelegate {
    func didEnterPassword(password: String, for account: TrustKeystore.Account, in viewController: EnterPasswordViewController) {
