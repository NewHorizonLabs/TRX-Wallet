...
class BrowserCoordinator: NSObject, Coordinator {
    ...
    private func executeTransaction(account: TrustKeystore.Account, action: DappAction, callbackID: Int, transaction: UnconfirmedTransaction, type: ConfirmType) {
    ...
    func signMessage(with type: SignMesageType, account: TrustKeystore.Account, callbackID: Int) {
