...
class BackupCoordinator: Coordinator {
    ...
    func presentActivityViewController(for account: TrustKeystore.Account, password: String, newPassword: String, completion: @escaping (Result<Bool, AnyError>) -> Void) {
    ...
    func presentShareActivity(for account: TrustKeystore.Account, password: String, newPassword: String) {
        self.presentActivityViewController(for: account, password: password, newPassword: newPassword) { result in
            self.finish(result: result)
        }
    }

    func export(for account: TrustKeystore.Account) {
...
extension BackupCoordinator: EnterPasswordCoordinatorDelegate {
    ...
    func didEnterPassword(password: String, account: TrustKeystore.Account, in coordinator: EnterPasswordCoordinator) {
